...
app.layout = html.Div(children=[
    ...
    html.Div(className="banner", children=[
        ...
        html.Div(className='container scalable', children=[
            # Change App Name here
            html.H2(html.A(
                'Cases Sales Focasting',
                href='https://www.larus.com/',
                style={
            ...
            html.A(
                html.Img(src="https://www.larus.com/wp-content/uploads/2011/07/LARUS_logo_v6.png"),
                href='https://www.larus.com/'
            )
        ]),
    ]),
                ...
                children=[
                    drc.Card([
                        ...
                        drc.NamedSlider(
                            ...
                            max=200,
                            step=25,
                            marks={i: i for i in [100, 125, 150, 175, 200]},
                            value=125
                        ),
